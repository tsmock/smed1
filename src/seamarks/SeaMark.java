...
public class SeaMark extends JPanel {
    ...
    public boolean testValid() {
        ...
        if (tmp) {
            ...
            dlg.messageBar.setText("Seamark not recognised");
            return false;
        }
    }
    ...
    public String validDecimal(String str) {
        ...
        if (!(str.isEmpty()) && !(str.matches("^[+-]??\\d+(\\.\\d+)??$"))) {
            dlg.messageBar.setText(Messages.getString("NotDecimal"));
            return "";
        } else {
            dlg.messageBar.setText("");
            return str;
    ...
    public String validDecimal(String str, float max) {
        ...
        if (!(str.isEmpty()) && (new Float(str) > max)) {
            dlg.messageBar.setText(Messages.getString("TooBig") + " (" + max + ")");
            return "";
        } else {
            dlg.messageBar.setText("");
            return str;
    ...
    public void parseMark(Node node) {
        ...
        if (str.equals("")) {
            dlg.messageBar.setText("No seamark");
        }
